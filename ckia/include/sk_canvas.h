...
SK_C_API int sk_canvas_save_layer(sk_canvas_t* ccanvas, const sk_rect_t* crect, const sk_paint_t* cpaint, const sk_imagefilter_t* backdrop, uint32_t layer_flags);
